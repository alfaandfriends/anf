...
var PopoverPanel = (0, import_vue20.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    useEventListener((_a = ownerDocument.value) == null ? void 0 : _a.defaultView, "focus", () => {
      ...
      if (!dom(api.panel))
        return;
      let activeElement = (_a2 = ownerDocument == null ? void 0 : ownerDocument.value) == null ? void 0 : _a2.activeElement;
      if (activeElement && (((_b = dom(api.panel)) == null ? void 0 : _b.contains(activeElement)) || ((_d = (_c = dom(api.beforePanelSentinel)) == null ? void 0 : _c.contains) == null ? void 0 : _d.call(_c, activeElement)) || ((_f = (_e = dom(api.afterPanelSentinel)) == null ? void 0 : _e.contains) == null ? void 0 : _f.call(_e, activeElement)))) {
        return;
      }
      api.closePopover();
    }, true);
        ...
        match(direction.value, {
          [0 /* Forwards */]: () => {
            ...
            for (let element of combined.slice()) {
              if (((_b = (_a2 = element == null ? void 0 : element.id) == null ? void 0 : _a2.startsWith) == null ? void 0 : _b.call(_a2, "headlessui-focus-sentinel-")) || (panel == null ? void 0 : panel.contains(element))) {
