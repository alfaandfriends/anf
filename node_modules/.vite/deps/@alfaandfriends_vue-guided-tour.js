<<<<<<< HEAD
import "./chunk-4ILCLBBR.js";
=======
import "./chunk-2HUOMYKY.js";
>>>>>>> dev
import {
  Fragment,
  Teleport,
  ...
  withCtx
<<<<<<< HEAD
} from "./chunk-53ALRBOC.js";
=======
} from "./chunk-HK46KJMT.js";
>>>>>>> dev
import {
  normalizeClass,
  normalizeProps,
  ...
  unref
<<<<<<< HEAD
} from "./chunk-FHZLNOZ4.js";
import "./chunk-XHWLKIPX.js";
=======
} from "./chunk-AWXLBNNW.js";
import "./chunk-DA74IYYC.js";
>>>>>>> dev

// node_modules/@alfaandfriends/vue-guided-tour/dist/vue-guided-tour.esm.js
...
var getBoundingWithPadding = function getBoundingWithPadding2(rect) {
...
var isInView = function isInView2(_ref) {
  var top = _ref.top, left = _ref.left, bottom = _ref.bottom, right = _ref.right;
  var _window = window, w = _window.innerWidth, h = _window.innerHeight;
  return top >= 0 && left >= 0 && right <= w && bottom <= h;
};
var isOutView = function isOutView2(_ref2) {
  var top = _ref2.top, left = _ref2.left, bottom = _ref2.bottom, right = _ref2.right;
  var _window2 = window, w = _window2.innerWidth, h = _window2.innerHeight;
  return {
    top: top < 0,
    left: left < 0,
    right: right > w,
...
var isPositionVertical = function isPositionVertical2(position) {
  return position === "top" || position === "bottom";
};
var rafThrottle = function rafThrottle2(fn) {
  var rafId;
  var lastArgs;
  return function() {
...
var script$2 = {
  ...
  setup(props, { emit }) {
    const { rect, allowInteraction, allowOverlayClose, allowEscClose } = toRefs(props);
    ...
    const updateRect = (rect2, { top = 0, left = 0, width = 0, height = 0 }) => {
      rect2.top = top;
      rect2.left = left;
      rect2.width = width;
      rect2.height = height;
      rect2.bottom = height + top;
      rect2.right = width + left;
    };
    ...
    const moveOverlaysRect = (callback = void 0) => {
      for (const overlayKey in overlaysRect) {
    ...
    const overlayFadeIn = (callback = void 0) => {
      overlayUpdate();
      moving.value = true;
      setTimeout(() => {
        moving.value = false;
    ...
    const overlayFadeOut = (callback = void 0) => {
      setTimeout(() => {
        resetOverlayWrapper();
        if (callback) {
          callback();
    ...
    const overlayClose = (callback) => {
      if (!active.value || moving.value)
        return;
      handleTargetUpdate(void 0, callback);
    };
    const overlayMoveTo = (newRect, callback) => {
      if (!active.value || moving.value || !newRect)
        return;
    ...
    const onOverlayClick = () => {
      if (!allowOverlayClose.value)
        return;
      emit("overlay-click");
      overlayClose();
    };
    const onKeyUp = (event) => {
      if (event.key !== "Escape" || !allowEscClose.value)
        return;
      emit("overlay-click");
      overlayClose();
    };
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock(Teleport, { to: "body" }, [
    createBaseVNode(
      "div",
      mergeProps({ class: "vue-guided-overlay" }, _ctx.$attrs),
      [
        createBaseVNode(
          "div",
          {
          ...
          [
            (openBlock(true), createElementBlock(
              Fragment,
              null,
              renderList($setup.overlaysRect, (overlay, key) => {
...
var script$1 = {
  ...
  setup(props) {
    ...
    const initPositionCoord = () => {
      ...
      const position2 = currentPosition.value;
      ...
      switch (placement) {
        case "end":
          isPositionVertical(position2) ? tx = tx - popoverWidth + rect.value.width : ty = ty - popoverHeight + rect.value.height;
          break;
        case "center":
          isPositionVertical(position2) ? tx = tx - popoverWidth / 2 + rect.value.width / 2 : ty = ty - popoverHeight / 2 + rect.value.height / 2;
          break;
      }
      x.value = tx;
      y.value = ty;
    ...
    const adjustCurrentPosition = () => {
      ...
      if (checkAvailableSpace(props.position)) {
        ...
        if (checkAvailableSpace(currentPosition.value))
          return;
    ...
    const checkAvailableSpace = (position2) => {
      const size = getSpaceSize()[position2];
      const { height: popoverHeight, width: popoverWidth } = popoverRef.value.getBoundingClientRect();
      const popoverSize = isPositionVertical(position2) ? popoverHeight : popoverWidth;
      const offset = props.offset + arrowRect.value.height;
...
function useArrow(props, popoverX, popoverY, popoverRef, position, rect) {
  ...
  const initArrowPositionCoord = () => {
    ...
    const offset2 = rotateOffset + radiusOffset;
    let tx = 0;
    let ty = 0;
    if (isPositionVertical(position.value)) {
      ty = position.value === "bottom" ? arrowRect.value.size / 2 : -(arrowRect.value.size / 2);
    } else {
      tx = position.value === "right" ? arrowRect.value.size / 2 : -(arrowRect.value.size / 2);
    }
    switch (placement) {
      case "center":
        isPositionVertical(position.value) ? tx = rect.value.left - popoverX.value + rect.value.width / 2 - arrowRect.value.size / 2 : ty = rect.value.top - popoverY.value + rect.value.height / 2 - arrowRect.value.size / 2;
        break;
      case "start":
        isPositionVertical(position.value) ? tx = rect.value.left - popoverX.value + offset2 : ty = rect.value.top - popoverY.value + offset2;
        break;
      case "end":
        isPositionVertical(position.value) ? tx = rect.value.width + rect.value.left - popoverX.value - arrowRect.value.size - offset2 : ty = rect.value.height + rect.value.top - popoverY.value - arrowRect.value.size - offset2;
        break;
    }
    const tMin = offset2;
    const tMax = (length) => length - arrowRect.value.height * 2 + offset2;
...
var _hoisted_1$1 = { class: "vgp__body" };
...
function useRect(target) {
  ...
  var update = function update2() {
    ...
    function setRect(_ref) {
      var _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height;
      rect.top = top;
      rect.left = left;
      rect.width = width;
      rect.height = height;
...
function useFocusTrap(target) {
  ...
  var enableTrap = function enableTrap2() {
    active.value = true;
  ...
  var disableTrap = function disableTrap2() {
    active.value = false;
  };
...
var script = {
  ...
  setup(props, { emit }) {
    ...
    const currentStep = computed(() => {
      ...
      return {
        ...
        popover: {
          ...stepObj.popover,
          role: "dialog",
          id: ((_a = stepObj.popover) == null ? void 0 : _a.id) || `popover-${uid}`,
          "aria-labelledby": stepObj.title ? `${((_b = stepObj.popover) == null ? void 0 : _b.id) || uid}-title` : null,
          "aria-describedby": stepObj.content ? `${((_c = stepObj.popover) == null ? void 0 : _c.id) || uid}-desc` : null
        },
        // overlay options
        overlay: {
          ...stepObj.overlay
    ...
    const onKeyUp = (event) => {
      if (!active.value || !allowKeyboardEvent.value)
        return;
      switch (event.key) {
        case "ArrowLeft":
          onPrev();
...
var _hoisted_1 = { class: "vgt__body" };
var _hoisted_2 = ["id"];
var _hoisted_3 = ["id"];
var _hoisted_4 = { class: "vgt__footer" };
var _hoisted_5 = {
  key: 0,
  class: "vgt__pages"
};
var _hoisted_6 = { class: "vgt__nav" };
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(Teleport, { to: "body" }, [
    createBaseVNode(
      ...
      [
        _ctx.useOverlay ? (openBlock(), createBlock(_component_vgt_overlay, mergeProps({
          key: 0,
          ref: "vgtOverlay",
        ...
        }, { ...$setup.currentStep.overlay }, { onOverlayClick: $setup.onOverlayClick }), null, 16, ["rect", "allow-overlay-close", "allow-esc-close", "allow-interaction", "onOverlayClick"])) : createCommentVNode("v-if", true),
        $setup.showPopover && ($setup.currentStep.title || $setup.currentStep.content || _ctx.$slots.content) ? (openBlock(), createBlock(Transition, {
          key: 1,
          name: "popover-appear",
          appear: ""
        }, {
          default: withCtx(() => [
            createVNode(_component_vgt_popover, mergeProps({
              ...
              default: withCtx(() => [
                _ctx.closeBtn ? renderSlot(_ctx.$slots, "close", { key: 0 }, () => [
                ...
                createBaseVNode("div", _hoisted_1, [
                  renderSlot(_ctx.$slots, "content", normalizeProps(guardReactiveProps({ stepIndex: $setup.currentStepIndex })), () => [
                    $setup.currentStep.title ? (openBlock(), createElementBlock("h3", {
                      key: 0,
                      id: $setup.currentStep.popover["aria-labelledby"],
                      class: "vgt__title"
                    }, toDisplayString($setup.currentStep.title), 9, _hoisted_2)) : createCommentVNode("v-if", true),
                    $setup.currentStep.content ? (openBlock(), createElementBlock("div", {
                      key: 1,
                      id: $setup.currentStep.popover["aria-describedby"],
                      class: "vgt__content"
                    }, toDisplayString($setup.currentStep.content), 9, _hoisted_3)) : createCommentVNode("v-if", true)
                  ])
                ]),
                createBaseVNode("div", _hoisted_4, [
                  _ctx.pagination ? (openBlock(), createElementBlock(
                    "div",
                    _hoisted_5,
                    toDisplayString($setup.currentStepIndex + 1) + " / " + toDisplayString(_ctx.steps.length),
                    1
                    /* TEXT */
                  )) : createCommentVNode("v-if", true),
              ...
              _: 3
              /* FORWARDED */
            }, 16, ["rect", "arrow", "offset", "position", "placement", "auto-adjust"])
          ]),
          _: 3
          /* FORWARDED */
        })) : createCommentVNode("v-if", true)
...
export {
  script$2 as VueGuidedOverlay,
  script$1 as VueGuidedPopover,
  script as VueGuidedTour,
  vgtPlugin as default,
  useRect
};
//# sourceMappingURL=@alfaandfriends_vue-guided-tour.js.map
