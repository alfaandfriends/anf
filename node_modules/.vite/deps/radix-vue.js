  ...
  setup(a2, { emit: t }) {
    ...
    watch(V2, (ue) => {
      if (Array.isArray(ue) && ue.length) {
        ...
        !Array.isArray(ue) && ue && !$14e0f24ef4ac5c92$export$91b62ebf2ba703ee(Y.value, ue) && J2(ue);
    });
    function De(ue) {
      if (f.value) {
        ...
        switch (P2.key) {
          ...
          case "Backspace": {
            ...
            if (h2.value) {
              ...
              P2.key === "Backspace" && (h2.value = k, P2.preventDefault());
            break;
          }
          case "Home":
          case "End":
