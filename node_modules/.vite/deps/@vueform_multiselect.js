...
function useDropdown(props, context, dep) {
  ...
  const dropdownStyles = computed(() => {
    ...
    maxHeight = maxHeight.match(/%/) ? parseInt(maxHeight.replace("%")) / 100 * window.innerHeight : parseInt(maxHeight.replace("px", ""));
    return {
      position: "absolute",
      zIndex: 9999,
      transform: openDirection.value === "top" ? `translateY(-100%)` : "none",
      maxHeight: openDirection.value === "top" ? maxHeight > spaceAbove ? `${spaceAbove}px` : maxHeight : maxHeight > spaceBelow ? `${spaceBelow}px` : void 0,
      left: `${msPos.x}px`,
  ...
  const getAllScrollableParents = (element) => {
    ...
    function checkScrollable(element2) {
      ...
      if (overflowY === "scroll" || overflowY === "auto") {
        scrollableParents.push(element2);
      }
      checkScrollable(element2.parentNode);
    }
...
var _hoisted_10 = ["data-pointed", "onMouseenter", "onMousedown"];
var _hoisted_11 = ["innerHTML"];
var _hoisted_12 = ["aria-label"];
var _hoisted_13 = ["data-pointed", "data-selected", "onMouseenter", "onMousedown", "id", "aria-selected", "aria-label"];
