...
function useOptions(props, context, dep) {
  ...
  const pfg = computed(() => {
    ...
    if (createdOption.value.length) {
      if ((_a = groups[0]) == null ? void 0 : _a.__CREATE__) {
...
function useI18n(props, context, dep) {
  ...
  const localize = (target) => {
    var _a, _b;
    return target && typeof target === "object" ? (target == null ? void 0 : target[locale.value]) || (target == null ? void 0 : target[(_a = locale.value) == null ? void 0 : _a.toUpperCase()]) || (target == null ? void 0 : target[fallbackLocale.value]) || (target == null ? void 0 : target[(_b = fallbackLocale.value) == null ? void 0 : _b.toUpperCase()]) || (target == null ? void 0 : target[Object.keys(target)[0]]) : target;
  };
  return {
    localize
  };
