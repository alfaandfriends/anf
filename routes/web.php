...
Route::prefix('diagnostic-test')->group(function () {
    Route::get('/', [DiagnosticTestController::class, 'dtMain'])->middleware('auth')->name('diagnostic_test');
    ...
    Route::get('/saved-results', [DiagnosticTestController::class, 'savedDtResults'])->name('diagnostic_test.saved_results');
    Route::post('/saved-result/save-status', [DiagnosticTestController::class, 'saveDtResultStatus'])->name('diagnostic_test.saved_results.save_status');
    Route::get('/saved-results/details', [DiagnosticTestController::class, 'savedDtResultsDetails'])->name('diagnostic_test.saved_results.details');
