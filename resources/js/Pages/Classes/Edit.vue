                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        <div class="grid grid-rows-2 grid-cols-1 sm:grid-cols-2 grid-flow-col gap-4">
                            <div class="sm:row-span-3">
                                <div class="mb-5">
                                    <h1 class="font-semibold text-indigo-800">Class Information</h1>
                                    <div class=" border-b border-dashed border-indigo-900 mt-1"></div>
                                </div>
                                <div class="grid grid-cols-1 sm:grid-cols-0 gap-0 sm:gap-4">
                                    <div class="mb-4">
                                        <label for="session_name" class="block text-sm font-medium text-gray-700"> Class <span class="text-red-500">*</span></label>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-0 sm:gap-4">
                                    <div class="mb-4">
                                        <label for="class_name" class="block text-sm font-medium text-gray-700"> Start Date <span class="text-red-500">*</span></label>
                                    ...
                                    <div class="mb-4">
                                        <label for="class_name" class="block text-sm font-medium text-gray-700"> End Date <span class="text-red-500">*</span></label>
...
export default {
    ...
    data(){
        return{
            form: {
                session_id: this.session_info ? this.session_info.ID : '',
                session: this.session_info ? this.session_info.label : '',
                start_date: this.session_info ? this.session_info.start_date : '',
                end_date: this.session_info ? this.session_info.end_date : ''
            }
        }
    },
    methods: {
        submit() {
            this.$inertia.post(route('sessions.update'), this.form, { preserveState: true})
        },
    }
