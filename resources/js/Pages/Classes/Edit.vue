                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        <div class="grid grid-rows-2 grid-cols-1 sm:grid-cols-2 grid-flow-col gap-4">
                            <div class="sm:row-span-3">
                                <div class="mb-5">
                                    <h1 class="font-semibold text-indigo-800 font-bold">Class Information</h1>
                                    <div class=" border-b border-dashed border-indigo-900 mt-1"></div>
                                </div>
                                <div class="grid grid-cols-1 sm:grid-cols-0 gap-0 sm:gap-4">
                                    <div class="mb-4">
                                        <label for="class_name" class="block text-sm font-medium text-gray-700 font-bold"> Class Name <span class="text-red-500">*</span></label>
                        ...
                        <div class="flex items-end justify-end">
                            <div class="pr-3">
                                ...
                                <Toggle v-model="form.class_active" 
                                    :classes="{
    ...
    data() {
        return {
            form: {
                ...
                class_name: this.class_info ? this.class_info.label : '',
                class_active: this.class_info ? this.class_info.status : '',
            },
        }
    },
    methods: {
