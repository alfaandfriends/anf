                                ...
                                <div class="overflow-hidden w-1/2">
                                    <form @submit.prevent="submit">
                                        <div class="bg-white px-3 py-2">
                                            ...
                                            <div class="mb-3">
                                                <label for="category_name" class="block text-sm text-gray-700 font-bold">Score less than<span class="text-red-500">*</span></label>
                                            ...
                                            <div class="flex items-end justify-end space-x-2">
                                                ...
                                                <Link :href="route('settings.diagnostic_test.details', {'dt_id': category_info.dt_id})" class="py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-400 hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 select-none">Cancel</Link>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
export default defineComponent({
    ...
    methods: {
        submit() {
            this.$inertia.post(route('settings.diagnostic_test.categories.update'), this.form, { preserveState: true})
        }
    }
