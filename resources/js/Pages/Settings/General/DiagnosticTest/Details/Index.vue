                            ...
                            <div class="overflow-hidden w-1/2 p-4">
                                <div class="flex justify-between border-b border-dashed border-indigo-900 mt-1 items-center mb-4">
                                    ...
                                    <div class="flex justify-start">
                                        <Link :href="route('settings.diagnostic_test.details.create', {'diagnostic_test_id': $page.props.diagnostic_test_id})" class="py-2 px-6 bg-blue-500 text-white  mb-2 rounded shadow">
                                            <div class="flex">
                                ...
                                <div class="space-y-6 pb-6">
                                    <div class="flex items-center px-3" v-for="(condition, index) in $page.props.diagnostic_test_conditions" :key="condition.id">
                                        ...
                                        <div class="flex flex-col space-y-1">
                                            ...
                                            <div class="rounded bg-red-500 hover:bg-red-700 p-1 text-white cursor-pointer">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                                </svg>
                                            </div>
...
export default defineComponent({
    ...
    updated(){
        console.log(this.$page.props.diagnostic_test_list)
    ...
    methods: {
        dtEdit(test_id, dt_id){
            this.$inertia.get(route('settings.diagnostic_test.details.edit'), {'test_id': test_id}, {preserveScroll: true})
        },
        dtDelete(test_id){
