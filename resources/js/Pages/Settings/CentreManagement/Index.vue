                        ...
                        <ul class="flex justify-start space-x-1 text-white">
                            ...
                            <li>
                                <button @click="currentTab('settings.programmes')" class="inline-block px-4 py-2"
                                        :class="route().current('settings.programmes') ? 'bg-white text-indigo-800 border-indigo-500 border-t-2' : 
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr class="hover:bg-gray-200" v-for="(fee_type_list, index) in $page.props.fee_type_list.data" :key="fee_type_list.ID">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm font-medium text-gray-900">{{ fee_type_list.label }}</div>
                                                </td>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr class="hover:bg-gray-200" v-for="(fee_period_list, index) in $page.props.fee_period_list.data" :key="fee_period_list.ID">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm font-medium text-gray-900">{{ fee_period_list.label }}</div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                                    <div class="flex justify-center">
                                                        <div class="flex pr-1">
