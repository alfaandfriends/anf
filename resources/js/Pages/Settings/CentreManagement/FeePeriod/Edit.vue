                ...
                <form @submit.prevent="submit">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div class="flex items-end justify-start space-x-2">
                            <BreezeButton buttonType="gray" :route="route('settings.fee_period_list')">Cancel</BreezeButton>
...
export default {
    ...
    props: {
        fee_period_info: Object
    },
    data(){
        return{
            form: {
                fee_period_id: this.fee_period_info ? this.fee_period_info.id : '',
                fee_period: this.fee_period_info ? this.fee_period_info.label : '',
            }
        }
    },
    methods: {
        submit() {
            this.$inertia.post(route('settings.fee_period_list.update'), this.form, { preserveState: true})
        },
    }
