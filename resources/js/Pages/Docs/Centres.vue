    ...
    <Main>
        <article class="">
            <header class="">
                ...
                <h1 class="text-3xl font-bold tracking-tight text-slate-900">Centres</h1>
                <div class="mt-3">
                    <span class="">This page provides information for centres module.</span>
                </div>
            </header>
            <div class="mt-10">
                    ...
                    <details class="group rounded-lg bg-indigo-50 border border-gray-500 p-6 [&_summary::-webkit-details-marker]:hidden">
                        ...
                        <p class="mt-4 leading-relaxed text-gray-700">
                            ...
                            <ul class="px-5 list-disc">
                                ...
                                <li><Link ::href="route('docs.edupreneurs')" class="hover:underline text-sm text-indigo-800 font-semibold">Edupreneurs</Link></li>
