    ...
    <Main>
        <article class="">
            <header class="">
                ...
                <h1 class="text-3xl font-bold tracking-tight text-slate-900">Countries</h1>
                <div class="mt-3">
                    <span class="">This page provides information for countries module.</span>
                </div>
            </header>
            <div class="mt-10">
                <p class="font-semibold tracking-normal text-slate-900 mb-1">Requirements</p>
                <span class="text-sm">No requirement needed.</span>
            </div>
            <div class="mt-10">
                <p class="font-semibold tracking-normal text-slate-900 mb-1">Actions</p>
                <span class="text-sm">View, Create, Delete</span>
            </div>
            <div class="mt-10">
                ...
                <div class="space-y-4">
                    <details class="group rounded-lg bg-indigo-50 border border-gray-500 p-6 [&_summary::-webkit-details-marker]:hidden">
                        <summary class="flex cursor-pointer items-center justify-between gap-1.5 text-gray-900">
                            <h2 class="font-medium">Cannot delete a country</h2>
                        ...
                        <p class="mt-4 leading-relaxed text-gray-700">
                            ...
                            <ul class="px-5 list-disc">
                                ...
                                <li><Link ::href="route('docs.profile')" class="hover:underline text-sm text-indigo-800 font-semibold">Profile</Link></li>
