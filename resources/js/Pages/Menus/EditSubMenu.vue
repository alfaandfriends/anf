                            ...
                            <div class="sm:row-span-3">
                                <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-1 gap-0 sm:gap-4">
                                        <div class="mb-4">
                                            <label for="menu_sub_label" class="block text-sm font-bold text-gray-700"> Sub Menu label <span class="text-red-500">*</span></label>
    ...
    data() {
        return {
            form: {
                ...
                menu_sub_permission_name: this.sub_menus.permission_name,
            },
        }
    },
    methods: {
