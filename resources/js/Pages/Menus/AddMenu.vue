                    ...
                    <div class="align-middle inline-block lg:w-1/3">
                        <div class="p-6 bg-white border-b border-gray-200">
                            <form @submit.prevent="submit">
                                <div>
                                    <label for="role">Menu Label</label>
                                ...
                                <div class="mt-4">
                                    <label for="role_name">SVG Icon</label>
                                    <textarea class="w-full px-4 py-2 mt-2 border rounded-md" v-model="form.role_name" 
                                           :class="$page.props.errors.role_name ? 'border-1 border-rose-500 focus:outline-none focus:ring-0 focus:border-rose-500' : 'focus:ring-0 focus:border-gray-500'"></textarea>
                                </div>
