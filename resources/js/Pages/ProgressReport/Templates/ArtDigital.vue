...
import { Plus, Wand2, Trash2Icon, XCircle } from "lucide-vue-next";
...
export default {
  ...
  methods: {
    ...
    getLessons(theme_id) {
      ...
      axios
        .get(route("progress_report.get_art_digital_lessons", theme_id))
        .then((response) => {
    ...
    getActivity(lesson_id) {
      ...
      axios
        .get(route("progress_report.get_art_digital_activities", lesson_id))
        .then((response) => {
    ...
    getOutcomes(activity_id) {
      ...
      axios
        .get(route("progress_report.get_art_digital_learning_outcomes", activity_id))
        .then((response) => {
    ...
    addItem() {
      ...
      if (
        ...
        if (itemExists) {
          ...
          axios
            .get(
              route("progress_report.get_art_digital_objectives", this.search.outcome_id)
            )
            .then((response) => {
              const new_item = {
