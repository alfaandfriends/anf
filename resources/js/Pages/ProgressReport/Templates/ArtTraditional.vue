...
export default {
    ...
    methods: {
        ...
        getLessons(theme_id) {
            ...
            axios.get(route('progress_report.get_art_traditional_lessons', theme_id))
            .then(response => {
        ...
        getActivity(lesson_id) {
            ...
            axios.get(route('progress_report.get_art_traditional_activities', lesson_id))
            .then(response => {
        ...
        getOutcomes(activity_id) {
            ...
            axios.get(route('progress_report.get_art_traditional_learning_outcomes', activity_id))
            .then(response => {
        ...
        addItem() {
            ...
            if(this.search.theme_id && this.search.lesson_id && this.search.activity_id && this.search.outcome_id) {
                ...
                if(itemExists){
                    ...
                    this.searching = true
                    axios.get(route('progress_report.get_art_traditional_objectives', this.search.outcome_id))
                    .then(response => {
                        const new_item  =   {
