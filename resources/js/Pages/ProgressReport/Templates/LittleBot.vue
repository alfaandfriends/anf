                ...
                <div class="p-6 overflow-y-auto scrollbar">
                    <div class="grid grid-rows-1">
                            ...
                            <div class="mb-3 col-span-5">
                                ...
                                <div class="mt-1 flex rounded-md.shadow-sm">
                                    <Multiselect 
                                        ...
                                        :searchable="true"
                                        :options="$page.props.little_bot_lessons"
                                        :clearOnSelect="false"
                                        :canClear="false"
                                        :canDeselect="false"
                                        trackBy="name"
                        ...
                        <div class="grid grid-cols-1 py-3">
                            <div class="mb-3">
                                <span class="block text-sm font-bold text-gray-700"> Objectives<span class="text-red-500">*</span> </span>
                            </div>
                                        ...
                                        <summary class="flex justify-between items-center font-medium cursor-pointer list-none">
                                            <div class="space-y-2 ml-2 text-sm">
                                                <div class="flex space-x-4 items-center justify-between">
                                                    <span class="text-slate-700 font-bold font-sans">{{ data.lesson_name }}: {{ data.topic_name }}</span>
