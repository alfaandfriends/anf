...
export default {
  ...
  methods: {
    ...
    getLessons(theme_id) {
      ...
      axios.get(route("progress_report.get_art_lessons", theme_id)).then((response) => {
    ...
    getActivity(lesson_id) {
      ...
      axios
        .get(route("progress_report.get_art_activities", lesson_id))
        .then((response) => {
    ...
    getOutcomes(activity_id) {
      ...
      axios
        .get(route("progress_report.get_art_learning_outcomes", activity_id))
        .then((response) => {
    ...
    addItem() {
      ...
      if (
        ...
        if (itemExists) {
          ...
          this.searching = true;
          axios
            .get(route("progress_report.get_art_objectives", this.search.outcome_id))
            .then((response) => {
              const new_item = {
