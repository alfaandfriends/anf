...
export default {
  ...
  methods: {
    ...
    getOutcomes(lesson_id) {
      ...
      axios
        .get(route("progress_report.get_little_artist_outcomes", lesson_id))
        .then((response) => {
      ...
      if (this.search.lesson_id && this.search.outcome_id) {
        ...
        if (dataExist) {
          ...
          axios
            .get(
              route(
                "progress_report.get_little_artist_objectives",
                this.search.outcome_id
              )
            )
            .then((response) => {
              const new_item = {
                ...
                lesson_name: this.$page.props.little_artist_lessons.find(
