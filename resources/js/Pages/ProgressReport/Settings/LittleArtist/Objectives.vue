            ...
            <Card>
                <template #title>
                    <div class="flex justify-between">
                        <Button @click="$inertia.get(route('progress_report.settings.little_artist.outcomes', {'level_id': $page.props.level_id, 'lesson_id': $page.props.lesson_id}))">Back</Button>
...
export default {
    ...
    methods: {
        ...
        store(){
            ...
            this.$inertia.post(route('progress_report.settings.little_artist.objectives.store'), this.form, {preserveState: false})
        },
        update(){
            if(!this.form.objective_name){
                this.errors.objective_name = true
            ...
            this.$inertia.post(route('progress_report.settings.little_artist.objectives.update'), this.form, {preserveState: false})
        },
        destroy(id){
            this.confirmation.route_name    = 'progress_report.settings.little_artist.objectives.destroy'
