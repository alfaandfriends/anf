...
export default {
    ...
    methods: {
        ...
        store(){
            ...
            this.$inertia.post(route('progress_report.settings.little_artist.levels.store'), this.form, {preserveState: false})
        },
        update(){
            if(!this.form.level_name){
                this.errors.level_name = true
            ...
            this.$inertia.post(route('progress_report.settings.little_artist.levels.update'), this.form, {preserveState: false})
        },
        destroy(id){
            this.confirmation.route_name    = 'progress_report.settings.little_artist.levels.destroy'
            this.confirmation.id            = id
            this.confirmation.is_open       = true
        },
        viewLessons(level_id){
            this.$inertia.get(route('progress_report.settings.little_artist.lessons'), {'level_id' : level_id})
        },
    }
}
</script>