            ...
            <Card>
                <template #title>
                    <div class="flex justify-between">
                        <Button @click="$inertia.get(route('progress_report.settings.coding_robotics.levels'))">Back</Button>
...
export default {
    ...
    methods: {
        ...
        destroy(id){
            this.confirmation.route_name    = 'progress_report.settings.coding_robotics.lessons.destroy'
