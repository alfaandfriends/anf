        ...
        <div class="py-4 px-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="flex justify-between pb-4 relative text-gray-400 focus-within:text-gray-600 items-center">
                    <BreezeButton buttonType="gray" :url="route('progress_report.settings.coding_robotics.topics', {'level_id': $page.props.level_id, 'lesson_id': $page.props.lesson_id})">Back</BreezeButton>
...
export default {
    ...
    methods: {
        ...
        destroy(id){
            this.confirmationRoute = 'progress_report.settings.coding_robotics.objectives.destroy'
