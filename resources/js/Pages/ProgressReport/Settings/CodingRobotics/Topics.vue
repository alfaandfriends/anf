            ...
            <Card>
                <template #title>
                    <div class="flex justify-between">
                        <Button @click="$inertia.get(route('progress_report.settings.coding_robotics.lessons', {'level_id': $page.props.level_id}))">Back</Button>
...
export default {
    ...
    methods: {
        ...
        destroy(id){
            this.confirmation.route_name    = 'progress_report.settings.coding_robotics.topics.destroy'
