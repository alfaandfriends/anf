...
export default {
    ...
    methods: {
        ...
        store(){
            ...
            this.$inertia.post(route('progress_report.settings.art_digital.levels.store'), this.form, {preserveState: false})
        },
        update(){
            if(!this.form.level_name){
                this.errors.level_name = true
            ...
            this.$inertia.post(route('progress_report.settings.art_digital.levels.update'), this.form, {preserveState: false})
        },
        destroy(id){
            this.confirmation.route_name    = 'progress_report.settings.art_digital.levels.destroy'
            this.confirmation.id            = id
            this.confirmation.is_open       = true
        },
        viewThemes(level_id){
            this.$inertia.get(route('progress_report.settings.art_digital.themes'), {'level_id' : level_id})
        },
    }
}
</script>