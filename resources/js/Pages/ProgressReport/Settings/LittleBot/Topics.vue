        ...
        <div class="py-4 px-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="flex justify-between pb-4 relative text-gray-400 focus-within:text-gray-600 items-center">
                    <BreezeButton buttonType="gray" :route="route('progress_report.settings.little_bot.lessons', {'level_id': $page.props.level_id})">Back</BreezeButton>
...
export default {
    ...
    methods: {
        ...
        destroy(id){
            this.confirmationRoute = 'progress_report.settings.little_bot.topics.destroy'
