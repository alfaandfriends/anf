            ...
            <Card>
                <template #title>
                    <div class="flex justify-between">
                        <Button @click="$inertia.get(route('progress_report.settings.little_bot.levels'))">Back</Button>
                            ...
                            <TableRow v-for="result, index in $page.props.lessons">
                                ...
                                <TableCell class="text-center">
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        <Button @click="viewTopics(result.id)">View Topics</Button>
                                    </div>
                                </TableCell>
                            </TableRow>
                        </TableBody>
...
export default {
    ...
    methods: {
        ...
        destroy(id){
            this.confirmation.route_name    = 'progress_report.settings.little_bot.lessons.destroy'
