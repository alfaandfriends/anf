            ...
            <Card>
                <template #title>
                    <div class="flex justify-between">
                        <Button @click="$inertia.get(route('progress_report.settings.art_traditional.themes', { 'level_id' : $page.props.level_id, 'theme_id' : $page.props.theme_id }))">Back</Button>
...
export default {
    ...
    methods: {
        ...
        store(){
            ...
            this.$inertia.post(route('progress_report.settings.art_traditional.lessons.store'), this.form, {preserveState: false})
        },
        update(){
            if(!this.form.lesson_name){
                this.errors.lesson_name = true
            ...
            this.$inertia.post(route('progress_report.settings.art_traditional.lessons.update'), this.form, {preserveState: false})
        },
        destroy(id){
            this.confirmation.route_name    = 'progress_report.settings.art_traditional.lessons.destroy'
            this.confirmation.id            = id
            this.confirmation.is_open       = true
        },
        viewActivities(lesson_id){
            this.$inertia.get(route('progress_report.settings.art_traditional.activities'), {'level_id': this.$page.props.level_id, 'theme_id': this.$page.props.theme_id, 'lesson_id' : lesson_id})
        },
    }
}
</script>