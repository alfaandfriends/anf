            ...
            <Card>
                <template #title>
                    <div class="flex justify-between">
                        <Button @click="$inertia.get(route('progress_report.settings.art_traditional.outcomes', {'level_id' : $page.props.level_id, 'theme_id' : $page.props.theme_id, 'lesson_id' : $page.props.lesson_id, 'activity_id' : $page.props.activity_id}))">Back</Button>
...
export default {
    ...
    methods: {
        ...
        store(){
            ...
            this.$inertia.post(route('progress_report.settings.art_traditional.objectives.store'), this.form, {preserveState: false})
        },
        update(){
            if(!this.form.objective_name){
                this.errors.objective_name = true
            ...
            this.$inertia.post(route('progress_report.settings.art_traditional.objectives.update'), this.form, {preserveState: false})
        },
        destroy(id){
            this.confirmation.route_name    = 'progress_report.settings.art_traditional.objectives.destroy'
