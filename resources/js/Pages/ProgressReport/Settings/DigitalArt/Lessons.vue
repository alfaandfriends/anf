        ...
        <div class="py-4 px-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="flex justify-between pb-4 relative text-gray-400 focus-within:text-gray-600 items-center">
                    <BreezeButton buttonType="gray" :url="route('progress_report.settings.digital_art.themes', { 'level_id' : $page.props.level_id, 'theme_id' : $page.props.theme_id })">Back</BreezeButton>
