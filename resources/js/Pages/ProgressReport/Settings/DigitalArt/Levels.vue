...
export default {
    ...
    methods: {
        ...
        store(){
            ...
            this.$inertia.post(route('progress_report.settings.digital_art.levels.store'), this.form, {preserveState: false})
        },
        update(){
            if(!this.form.level_name){
                this.errors.level_name = true
            ...
            this.$inertia.post(route('progress_report.settings.digital_art.levels.update'), this.form, {preserveState: false})
        },
        destroy(id){
            this.confirmationRoute = 'progress_report.settings.digital_art.levels.destroy'
            this.confirmationData = id
            this.isOpen = true
        },
        viewThemes(level_id){
            this.$inertia.get(route('progress_report.settings.digital_art.themes'), {'level_id' : level_id})
        },
    }
}
</script>