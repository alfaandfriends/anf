        ...
        <div class="py-4 px-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="flex justify-between pb-4 relative text-gray-400 focus-within:text-gray-600 items-center">
                    <BreezeButton buttonType="gray" class="py-2 px-4" :route="route('progress_report.settings.digital_art.lessons', {'level_id' : $page.props.level_id, 'theme_id' : $page.props.theme_id})">Back</BreezeButton>
                                ...
                                <tr class="hover:bg-gray-200" v-for="(result, index) in $page.props.activities">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            <BreezeButton buttonType="blue" class="py-1 px-2" @click="viewOutcomes(result.id)">View Outcomes</BreezeButton>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
