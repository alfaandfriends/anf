...
<template>
    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="py-4 px-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="flex justify-between pb-4 relative text-gray-400 focus-within:text-gray-600 items-center">
                    <BreezeButton buttonType="gray" class="py-2 px-4" :route="route('progress_report.settings.digital_art.activities', {'level_id' : $page.props.level_id, 'theme_id' : $page.props.theme_id, 'lesson_id' : $page.props.lesson_id, 'activity_id' : $page.props.activity_id})">Back</BreezeButton>
        ...
        <ConfirmationModal 
            ...
            confirmationText="Are you sure want to delete this objective? This action cannot be undone."
...
export default {
    ...
    data(){
        return{
            ...
            form:{
                id: '',
                outcome_id: this.$page.props.outcome_id,
                objective_name: ''
            },
            errors:{
    ...
    methods: {
        ...
        store(){
            ...
            this.$inertia.post(route('progress_report.settings.digital_art.objectives.store'), this.form, {preserveState: false})
        },
        update(){
            if(!this.form.objective_name){
                this.errors.objective_name = true
            ...
            this.$inertia.post(route('progress_report.settings.digital_art.objectives.update'), this.form, {preserveState: false})
        },
        destroy(id){
            this.confirmationRoute = 'progress_report.settings.digital_art.objectives.destroy'
