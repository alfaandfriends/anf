            ...
            <Card>
                <template #title>
                    <div class="flex justify-between">
                        <Button @click="$inertia.get(route('progress_report.settings.digital_art.activities', {'level_id' : $page.props.level_id, 'theme_id' : $page.props.theme_id, 'lesson_id' : $page.props.lesson_id}))">Back</Button>
...
export default {
    ...
    methods: {
        ...
        destroy(id){
            this.confirmation.route_name    = 'progress_report.settings.digital_art.outcomes.destroy'
