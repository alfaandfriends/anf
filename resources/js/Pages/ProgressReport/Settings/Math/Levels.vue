...
<template>
    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="py-4 px-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="flex justify-end pb-4 relative text-gray-400 focus-within:text-gray-600 items-center">
                    <div class="flex">
                        <BreezeButton @click="create">New Level</BreezeButton>
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-300">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-4/12">Level</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-if="!$page.props.levels.length">
                                ...
                                <tr class="hover:bg-gray-200" v-for="(result, index) in $page.props.levels">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            <BreezeButton buttonType="blue" @click="viewTermBook(result.id)">View Terms / Books</BreezeButton>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                ...
                <div class="space-y-2" v-if="show_create">
                    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md">
                        <div class="mb-5 border-b-indigo-500 border-b border-dashed">
                            <h2 class="font-display font-bold text-indigo-600">New Level</h2>
                        </div>
        ...
        <ConfirmationModal 
            ...
            confirmationText="Are you sure want to delete this level? Please be aware that deleting this will also result in the deletion of all associated data. This action cannot be undone."
...
export default {
    ...
    methods: {
        ...
        store(){
            ...
            this.$inertia.post(route('progress_report.settings.math.levels.store'), this.form, {preserveState: false})
        },
        update(){
            if(!this.form.level_name){
                this.errors.level_name = true
            ...
            this.$inertia.post(route('progress_report.settings.math.levels.update'), this.form, {preserveState: false})
        },
        destroy(id){
            this.confirmationRoute = 'progress_report.settings.math.levels.destroy'
            this.confirmationData = id
            this.isOpen = true
        },
        viewTermBook(level_id){
            this.$inertia.get(route('progress_report.settings.math.terms_books'), {'level_id' : level_id})
        },
    }
}
</script>