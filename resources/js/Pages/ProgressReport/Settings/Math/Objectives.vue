            ...
            <Card>
                <template #title>
                    <div class="flex justify-between">
                        <Button @click="$inertia.get(route('progress_report.settings.math.lessons', {'level_id': $page.props.level_id, 'term_book_id': $page.props.term_book_id, 'unit_id': $page.props.unit_id}))">Back</Button>
...
export default {
    ...
    methods: {
        ...
        destroy(id){
            this.confirmation.route_name    = 'progress_report.settings.math.objectives.destroy'
