        ...
        <div class="py-4 px-4">
            <template v-if="$page.props.can.view_progress_report_settings">
                <div class="flex justify-end">
                    ...
                    <BreezeButton class="py-2 px-4 space-x-2" :url="route('progress_report.settings')">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6 gap-2 mb-3">
                ...
                <div class="w-full">
                    <BreezeButton buttonType="gray" class="py-2 px-3" :url="route('progress_report')">Clear Search</BreezeButton>
                </div>
            </div>
            <!-- <hr class="my-3 border border-dashed border-gray-400">
