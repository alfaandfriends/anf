                        ...
                        <div class="flex flex-wrap gap-4 flex-col md:flex-row">
                            <div class="flex">
                                <div class="flex w-full relative text-gray-400">
                                    ...
                                    <input class="w-full border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg focus:ring-0 focus:border-gray-300 appearance-none font-sans leading-snug text-gray-400 block pl-10"
                                ...
                                <tr class="hover:bg-gray-200" v-for="(result, index) in $page.props.progress_reports.data" :key="result.report_id">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            <BreezeButton class="py-1 px-2" @click="showProgressReport(result.progress_report_id, result.student_fee)">{{ generate.id == result.progress_report_id && generate.running ? 'Generating...'  : 'Show / Print'}}</BreezeButton>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
