                                                ...
                                                <tr v-for="item, index in form.invoice_items">
                                                    ...
                                                    <td class="border text-sm py-2 px-4">
                                                        <div class="grid grid-rows-1 gap-2">
                                                            ...
                                                            <div class="flex flex-col space-y-2 pl-5">
                                                                ...
                                                                <div class="bg-indigo-100 py-1 px-3 rounded-sm" v-if="item.include_registration_fee && item.registration_fee != 0">
                                                    ...
                                                    <td class="border text-sm py-2 px-4 align-bottom">
                                                        <div class="flex flex-col space-y-1.5">
                                                            ...
                                                            <input v-if="item.include_registration_fee && item.registration_fee != 0" type="number" min="0" name="" id="" class="bg-gray-50 py-1 focus:ring-0 focus:border-indigo-300 flex-1 block w-full rounded-md sm:text-sm border-gray-300 cursor-not-allowed" v-model="item.registration_fee_discount" autocomplete="off" @input="numbersOnly" disabled>
                                                            <input v-if="item.include_material_fee && item.material_fee != 0" type="number" min="0" name="" id="" class="bg-gray-50 py-1 focus:ring-0 focus:border-indigo-300 flex-1 block w-full rounded-md sm:text-sm border-gray-300 cursor-not-allowed" v-model="item.material_fee_discount" autocomplete="off" @input="numbersOnly" disabled>
                                                    ...
                                                    <td class="border text-sm py-2 px-4 align-bottom">
                                                        <div class="flex flex-col space-y-1.5">
                                                            ...
                                                            <input v-if="item.include_registration_fee && item.registration_fee != 0" type="number" min="0" name="" id="" class="bg-gray-50 py-1 focus:ring-0 focus:border-indigo-300 flex-1 block w-full rounded-md sm:text-sm border-gray-300 cursor-not-allowed" v-model="item.registration_fee" autocomplete="off" @input="numbersOnly" disabled>
                                                            <input v-if="item.include_material_fee && item.material_fee != 0" type="number" min="0" name="" id="" class="bg-gray-50 py-1 focus:ring-0 focus:border-indigo-300 flex-1 block w-full rounded-md sm:text-sm border-gray-300 cursor-not-allowed" v-model="item.material_fee" autocomplete="off" @input="numbersOnly" disabled>
