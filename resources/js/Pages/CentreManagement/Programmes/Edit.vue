...
<template>
    ...
    <BreezeAuthenticatedLayout>
        ...
        <Modal :showModal="show.edit_fee" modalType="sm" @hideModal="show.edit_fee = false">
            <template v-slot:header>
                <div class="flex items-center justify-between py-3 px-4 border-b rounded-t font-semibold">     
                    ...
                    <button type="button" @click="show.edit_fee = false" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="default-modal">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    </button>
                </div>          
            </template>
        ...
        <ConfirmationModal 
            ...
            confirmationText="Are you sure want to delete this fee? Changes will be made once you clicked <span class='font-bold text-red-500'>CONFIRM</span>. Please be certain and this action is irreversible!"
            confirmationButton="Confirm"
            confirmationMethod="delete"
            :confirmationRoute="'programmes.fee.destroy'"
...
export default {
    ...
    methods: {
        ...
        deleteLevel(programme_level_id, index){
            ...
            this.confirmationData = programme_level_id
