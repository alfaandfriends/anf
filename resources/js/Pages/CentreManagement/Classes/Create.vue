                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-1 gap-0 sm:gap-4">
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-0 sm:gap-4">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                    <select name="programme" id="programme" class="focus:ring-0 focus:border-indigo-300 flex-1 block w-full rounded-md sm:text-sm" :class="$page.props.errors.programme ? 'border-red-300' : 'border-gray-300'" v-model="form.programme_id" autocomplete="off">
