            ...
            <div class="md:mt-0 md:col-span-2">
                <form @submit.prevent="submit">
                    <div class="px-4 py-5 bg-indigo-50 space-y-6 sm:p-6">
                        <div class="grid grid-rows-2 grid-cols-1 sm:grid-cols-1 grid-flow-col gap-4">
                                            ...
                                            <div class="mt-1 flex rounded-md.shadow-sm">
                                                <Multiselect 
                                                    ...
                                                    :classes="{
                                                        ...
                                                        search: 'w-full inset-0 outline-none focus:ring-0 appearance-none box-border border-0 text-base font-sans bg-white rounded pl-3.5 h-9',
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-0 sm:gap-4">
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-0 sm:gap-4">
                                            <div class="mb-4">
                                                ...
                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                    <select name="class_type" id="class_type" class="focus:ring-0 focus:border-indigo-300 flex-1 block w-full rounded-md sm:text-sm" :class="$page.props.errors.class_type ? 'border-red-300' : 'border-gray-300'" v-model="form.class_type" autocomplete="off" :disabled="disable_class_types">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                    <select name="programme_level_id" id="programme_level_id" class="focus:ring-0 focus:border-indigo-300 flex-1 block w-full rounded-md sm:text-sm" :class="$page.props.errors.programme_level_id ? 'border-red-300' : 'border-gray-300'" v-model="form.programme_level_id" autocomplete="off" :disabled="disable_class_levels">
        ...
        return{
            ...
            form: {
                ...
                start_time: {
                    ...
                    'minutes' : new Date(new moment(this.class_info.start_time, 'HH:mm:ss')).getMinutes(),
                    'seconds' : new Date(new moment(this.class_info.start_time, 'HH:mm:ss')).getSeconds(),
                },
                end_time: {
                    'hours' : new Date(new moment(this.class_info.end_time, 'HH:mm:ss')).getHours(),
                    'minutes' : new Date(new moment(this.class_info.end_time, 'HH:mm:ss')).getMinutes(),
                    'seconds' : new Date(new moment(this.class_info.end_time, 'HH:mm:ss')).getSeconds(),
                },
