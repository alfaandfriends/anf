...
<template>
    ...
    <BreezeAuthenticatedLayout>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                    <Multiselect 
                                                        ...
                                                        :placeholder="$page.props.order_info.student_name"
                                                        ...
                                                        :classes="{
                                                            container: 
                                                                ...
                                                                'relative mx-auto w-full flex items-center justify-end box-border cursor-pointer border border-red-300 rounded-md sm:text-sm leading-snug outline-none h-10':
                                                                'relative mx-auto w-full flex items-center justify-end box-border cursor-pointer border border-gray-300 rounded-md sm:text-sm leading-snug outline-none h-10',
                                                            ...
                                                            placeholder: 'flex items-center h-full absolute left-0 top-0 pointer-events-none bg-transparent leading-snug pl-3.5 text-gray-800',
                        ...
                        <div class="grid grid-rows-1 grid-cols-1 sm:grid-cols-1 grid-flow-col gap-4">
                            <div class="sm:row-span-3">
                                <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md">
                                    ...
                                    <div class="grid grid-cols-2 sm:grid-cols-2 gap-0 sm:gap-4">
                                        <div class="mb-4">
                            ...
                            <div class="sm:row-span-3">
                                <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        <BreezeButton @click="storeOrder">Update Order</BreezeButton>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <Modal :showModal="show.add_order" :modalType="'md'" @hideModal="show.add_order = false">
            <template v-slot:header>
                <div class="flex items-center justify-between py-3 px-4 border-b rounded-t font-semibold">              
                    ...
                    <button type="button" @click="show.add_order = false" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="default-modal">
        ...
        <Modal :showModal="show.add_tracking_status" :modalType="'md'" @hideModal="show.add_tracking_status = false">
            <template v-slot:header>
                <div class="flex items-center justify-between py-3 px-4 border-b rounded-t font-semibold">        
                    <h3 class="text-gray-900 text-xl font-semibold">                
                        Add Status
                    </h3>   
                    <button type="button" @click="show.add_tracking_status = false" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="default-modal">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    </button>
                </div>                    
            </template>
