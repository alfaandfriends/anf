        ...
        <div class="flex justify-center">
            <div class="flex-1 max-w-2xl">
                ...
                <div class="mt-3 flex flex-col space-y-3 bg-white py-3 px-4 shadow-md rounded" v-for="post, post_index in $page.props.posts">
                    ...
                    <img @dblclick="toggleLike(post_index)" :src="'storage/posts/' + post.post_image" class="select-none">
                    <div class="flex items-center space-x-4">
                        <div class="">
                            <svg v-if="post.liked" @click="toggleLike(post_index)" xmlns="http://www.w3.org/2000/svg" class="inline-block h-8 w-8 text-red-500 cursor-pointer" fill="currentColor" viewBox="0 0 512 512">
                                <path d="M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9L464.4 300.4c30.4-28.3 47.6-68 47.6-109.5v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5z"/>
                            </svg>
                            <svg v-else @click="toggleLike(post_index)" xmlns="http://www.w3.org/2000/svg" class="inline-block h-8 w-8 text-gray-500 hover:text-red-500 cursor-pointer" fill="currentColor" viewBox="0 0 512 512">
                        ...
                        <span class="text-xs font-semibold" v-if="post.liked">You liked this</span>
                        ...
                        <div class="flex flex-row">
                            ...
                            <div class="flex-col mt-1">
                                ...
                                <button class="inline-flex items-center px-1 pt-2 ml-1 flex-column">
                                    <svg class="8 h-5 ml-2 text-gray-600 cursor-pointer fill-current hover:text-gray-900"
