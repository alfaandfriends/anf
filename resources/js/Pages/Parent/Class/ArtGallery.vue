<template>
    ...
    <Authenticated>
        ...
        <div class="max-w-xl mx-auto mt-5"> 
            <div class="bg-white overflow-hidden shadow rounded-lg border p-6 min-h-[600px]">
                ...
                <div class="mb-3 flex flex-col space-y-2 justify-between items-end">
                    <Multiselect 
                    ...
                    />
                    <div @click="getArtwork" class="w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 shadow-sm shadow-slate-400 hover:shadow-slate-600 text-white p-2.5 cursor-pointer">
                        <div class="flex items-center space-x-4">
                            ...
                            <span class="" v-if="!searching.artworks">Search</span>
                            <span class="" v-else>Searching...</span>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="!init && artworks.length < 1" class="p-4 text-sm text-gray-800 rounded-lg bg-gray-50 text-center" role="alert">
                    <span class="font-medium">Nothing found.</span>
                </div>
                ...
                <div class="flex items-end justify-end fixed bottom-24 right-4 md:hidden lg:hidden" v-if="$page.props.current_active_child.student_id">
    ...
    <SimpleModal :isOpen="show_confirmation" @close="this.show_confirmation = false" class="h-10">
