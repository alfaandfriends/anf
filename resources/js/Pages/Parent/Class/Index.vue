      ...
      <simplebar data-simplebar-auto-hide="true">
        ...
        >
          <div
            ...
            @click="
              $inertia.get(
                route('parent.stories', $page.props.current_active_programme.encrypted_id)
              )
            "
          >
          ...
          <div
            ...
            v-if="
              $page.props.current_active_programme.id == 3 ||
              $page.props.current_active_programme.id == 5
            "
          >
    ...
    <div class="max-w-xl mx-auto mt-5">
      ...
      >
        ...
        <div class="space-y-2" v-if="show_comment">
          ...
          <textarea
            class="bg-white border border-gray-300 p-2 px-3.5 rounded-lg w-full resize-none focus:ring-0 focus:border-2 focus:border-indigo-300 text-sm"
            rows="2"
          ...
          <div class="flex justify-end" @click="postComment(story_index, story.story_id)">
            <button
              class="px-4 py-2 text-xs bg-indigo-600 hover:bg-indigo-700 text-white rounded-md"
            >
              Comment
            </button>
          </div>
      ...
      if (scrollTop + clientHeight >= scrollHeight - 100) {
        if (this.$page.props.stories.next_page_url) {
          if (!this.loading.stories) {
            ...
            axios
              .get(
                route("parent.student_stories", [
                  this.$page.props.session_data.current_active_child.student_id,
                  this.$page.props.session_data.current_active_programme.id,
                ]),
                {
                  params: {
