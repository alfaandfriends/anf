            ...
            <div class="flex-1 max-w-4xl">
                ...
                <div class="">
                    <div class="grid divide-y divide-neutral-200 max-w-xl md:hidden">
                                    ...
                                    <div class="flex flex-col">
                                        <div class="flex items-center justify-center p-4">
                                            <div class="relative inline-block cursor-pointer">
                                                <img :src="form.profile_photo.value" alt="Avatar" class="rounded-full w-28 h-28" v-if="$page.props.auth.user.user_photo != ''"/>
                        ...
                        <a :href="route('parent.profile.security')" class="flex justify-between items-center font-semibold cursor-pointer list-none bg-indigo-100 px-5 py-3">
