<template>
        ...
        <div class="flex justify-center">
            <div class="flex-1 max-w-xl space-y-4">
                ...
                <div class="flex justify-center mb-3">
                    <Button type="button" buttonType="info" @click="showAddChild">
    ...
    <Dialog v-model:open="show_add_child" classProp="max-w-md">
      <template #title>Add Child</template>
      <template #content>
        <div class="grid grid-cols-1 gap-4 mb-5">
            <div class="">
                <Label>Name</Label>
                <Input type="text" :error="errors.name" v-model="child_form.name"></Input>
            </div>
            <div class="">
      ...
      <template #footer>
        <div class="flex justify-end items-center space-x-2">
            <Button variant="outline" @click="show_add_child = false" v-if="!adding">Cancel</Button>
            <Button @click="addChild" buttonType="info" class="px-4 py-2">
...
export default {
    ...
    methods: {
        deleteChild(child_id){
            this.confirmation.route_name    = 'children.destroy'
            this.confirmation.id            = child_id
