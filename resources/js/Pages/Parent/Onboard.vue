    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-indigo-100">
        <div class="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-6 py-8 rounded-md w-full max-w-xl">
            <div class="flex flex-col items-center" v-if="current_step == 1">
                <p class="text-lg font-medium text-gray-600">Hello, {{ $page.props.auth.user.display_name }}!</p>
                <h1 class="md:text-2xl font-medium text-indigo-600">Welcome to ALFA and Friends Centre</h1>
                <div class="mt-10 space-y-2 px-10">
                    <h1>
                        What is Lorem Ipsum?
            ...
            <div class="" v-if="current_step == 3">
                ...
                <div class="mt-16 my-5">
                    <p class="text-center text-lg font-medium capitalize">Update your profile</p>
                </div>
                <div class="flex flex-col px-5 sm:px-10">
                    <div class="mb-5">
                        <label for="user_name" class="font-semibold text-sm">Full Name
                            <input type="text" id="user_name" class="mt-1 h-12 focus:ring-0 border-gray-300 focus:border-gray-300 flex-1 block w-full rounded-md" v-model="form.full_name" autocomplete="none"/>
                        </label>
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        <label for="use_phone" class="font-semibold text-sm">Phone Number
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input class="h-12 text-center inline-flex items-center px-2 rounded-l-md border border-r-0 border-gray-300 bg-gray-100 text-gray-500" v-model="form.calling_code" size="5" disabled>
                                <input type="number" name="use_phone" id="use_phone" class="h-12 focus:ring-0 border-gray-300 focus:border-gray-300 flex-1 block w-full rounded-none rounded-r-md" :class="$page.props.errors.contact_number ? 'border-red-300' : 'border-gray-300'" v-model="form.contact_number" autocomplete="none"/>
                            </div>
                        </label>
                    </div>
                    <div class="mb-5">
