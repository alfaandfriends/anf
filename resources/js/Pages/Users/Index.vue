                                    ...
                                    <tr class="hover:bg-gray-200" v-for="user in $page.props.user_list.data" :key="user.ID">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <div class="flex justify-center">
                                                <div class="flex pr-1">
                                                    <button class="flex space-x-2 items-center bg-blue-500 hover:bg-blue-600 text-white font-bold py-1 px-1 border border-blue-700 rounded" title="Assign Roles" @click="assignRoles(user.ID)">
                                                        ...
                                                        <span class="mt-0.5">Centre & Role Assigments </span> 
                                                    </button>
                                                </div>
                                                <div class="flex">
