                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-if="!$page.props.centre_managers.data.length">
                                    ...
                                    <tr class="hover:bg-gray-200" v-for="(user, index) in $page.props.centre_managers.data" :key="user.ID">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <div class="flex justify-center">
                                                <div class="flex pr-1">
                                                    <BreezeButton buttonType="blue" title="Edit Class" @click="manageUser(user.id)" v-if="$page.props.can.manage_centre_manager">Manage</BreezeButton>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
