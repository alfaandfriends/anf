        ...
        <div class="py-4 px-4">
            ...
            <div class="overflow-x-auto">
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            ...
                            <tr class="hover:bg-gray-200" v-for="(user, index) in $page.props.division_managers.data" :key="user.ID">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div class="flex justify-center">
                                        <div class="flex pr-1">
                                            <BreezeButton buttonType="blue" title="Manage User" @click="manageUser(user.id)" v-if="$page.props.can.manage_division_manager">Manage</BreezeButton>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <Pagination :page_data="$page.props.division_managers" :params="params"></Pagination>
                </div>
            </div>
            <ConfirmationModal 
                :show="isOpen" 
