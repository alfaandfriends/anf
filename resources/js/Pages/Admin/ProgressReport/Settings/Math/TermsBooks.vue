        ...
        <div class="py-4 px-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="flex justify-between pb-4 relative text-gray-400 focus-within:text-gray-600 items-center">
                    <BreezeButton buttonType="gray" :route="route('progress_report.settings.math.levels')">Back</BreezeButton>
                    <BreezeButton @click="create">New Term / Book</BreezeButton>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div class="space-y-2">
                                ...
                                <tr class="hover:bg-gray-200" v-for="(result, index) in $page.props.terms_books">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            <BreezeButton buttonType="blue" @click="viewUnits(result.id)">View Units</BreezeButton>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
