...
<template>
    ...
    <BreezeAuthenticatedLayout>
        ...
        <Modal :showModal="show_progress_report" :modalType="'lg'" @hideModal="show_progress_report = false"  ref="progress_report">
...
import StudentInformation from '@/Pages/Admin/ProgressReport/Templates/StudentInformation.vue';
