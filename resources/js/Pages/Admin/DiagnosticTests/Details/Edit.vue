                    ...
                    <div class="px-4 py-5 bg-indigo-100 space-y-6 sm:p-6 h-full">
                        <div class="grid grid-rows-1 grid-cols-1 sm:grid-cols-1 grid-flow-col gap-4">
                            <div class="sm:row-span-3 space-y-2">
                                ...
                                <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="w-1/4 relative group mt-2" v-if="showImage">
                                            <div class="absolute w-full h-full hover:bg-black hover:opacity-75 hidden rounded group-hover:block">
                                ...
                                <SingleChoice v-if="form.question_type == 1" @receivedData="appendToForm" :prop_answers="diagnostic_test_answers" action="edit"></SingleChoice>
                                <MultipleChoices v-if="form.question_type == 2" @receivedData="appendToForm" :prop_answers="diagnostic_test_answers" action="edit"></MultipleChoices>
                                <MatrixSorting v-if="form.question_type == 3" @receivedData="appendToForm" :prop_answers="diagnostic_test_answers" action="edit"></MatrixSorting>
                                <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md">
                                    <div class="flex items-end justify-end space-x-2">
                                        <BreezeButton buttonType="gray" @click="dtEdit()">Cancel</BreezeButton>
...
import SingleChoice from '@/Pages/Admin/DiagnosticTests/AnswerTemplates/SingleChoice.vue'
import MultipleChoices from '@/Pages/Admin/DiagnosticTests/AnswerTemplates/MultipleChoices.vue'
import MatrixSorting from '@/Pages/Admin/DiagnosticTests/AnswerTemplates/MatrixSorting.vue'
...
export default defineComponent({
    ...
    props:{
        ...
        diagnostic_test_answers: Object,
        redirect_url: String
    },
    data() {
        return {
            ...
            isOpen: false,
            showdtDetails: true,
            showUpload: this.$page.props.diagnostic_test_info.question_image === null || this.$page.props.diagnostic_test_info.question_image === '',
            showImage: this.$page.props.diagnostic_test_info.question_image !== null || this.$page.props.diagnostic_test_info.question_image !== '',
            confirmationTitle: '',
            confirmationText: '',
            confirmationAlert: '',
            confirmationButton: '',
            ...
            form: {
                ...
                redirect_yes: this.diagnostic_test_info.redirect_yes_id != null ? this.diagnostic_test_info.redirect_yes_id : '',
                redirect_no: this.diagnostic_test_info.redirect_no_id != null ? this.diagnostic_test_info.redirect_no_id : '',
                question_type: this.diagnostic_test_info ? this.diagnostic_test_info.question_type : '',
                question: this.diagnostic_test_info ? this.diagnostic_test_info.question : '',
                remarks: this.diagnostic_test_info ? this.diagnostic_test_info.remarks : '',
                delete_image: false,
                image_url: '',
                image_file: '',
                question_answer_data: this.diagnostic_test_answers ? this.diagnostic_test_answers : [],
            }
        };
    },
    methods: {
        submit() {
            this.$inertia.post(route('dt.settings.details.update'), this.form, { preserveState: true})
        },
        read(file, event) {
        ...
        removeImage(){
            this.form.image_url = ''
            if(this.$page.props.diagnostic_test_info.question_image != null){
        ...
        dtEdit(){
            this.$inertia.get(route('dt.settings.details'), {'dt_id': this.dt_id}, {preserveScroll: true,})
        },
        dtDelete(test_id){
