    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="py-4 px-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="align-middle inline-block min-w-full">
                            <div class="flex justify-between pb-4 relative text-gray-400 focus-within:text-gray-600 items-center">
                                <BreezeButton buttonType="gray" class="py-2 px-4" :route="route('art_gallery.setting.levels')">Back</BreezeButton>
                            ...
                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="hover:bg-gray-200" v-for="(result, index) in $page.props.themes" :key="result.id">
            ...
            <ConfirmationModal 
                ...
                confirmationText="Are you sure want to delete this theme?"
...
export default {
    ...
    methods: {
        ...
        destroy(id){
            this.confirmationRoute = 'art_gallery.setting.themes.delete'
