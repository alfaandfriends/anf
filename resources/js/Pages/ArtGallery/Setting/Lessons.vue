    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="py-4 px-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="align-middle inline-block min-w-full">
                            <div class="flex justify-between pb-4 relative text-gray-400 focus-within:text-gray-600 items-center">
                                <BreezeButton buttonType="gray" class="py-2 px-4" :route="route('art_gallery.setting.themes', {'level_id': $page.props.level_id})">Back</BreezeButton>
                            ...
                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="hover:bg-gray-200" v-for="(result, index) in $page.props.lessons" :key="result.id">
                        ...
                        <div class="space-y-2" v-if="show_create">
                            <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md">
                                <div class="mb-5 border-b-indigo-500 border-b border-dashed">
                                    <h2 class="font-display font-bold text-indigo-600">Add Lesson</h2>
                                </div>
            ...
            <ConfirmationModal 
                ...
                confirmationText="Are you sure want to delete this lesson?"
...
export default {
    ...
    methods: {
        ...
        destroy(id){
            this.confirmationRoute = 'art_gallery.setting.lessons.delete'
