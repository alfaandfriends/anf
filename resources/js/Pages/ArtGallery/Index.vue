...
<template>
    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="py-4 px-4">
            <div class="flex justify-end mb-3" v-if="$page.props.can.create_art_gallery">
                <BreezeButton class="py-2 px-4 rounded-r-none border-r border-r-white" :route="route('art_gallery.create')">Upload Artwork</BreezeButton>
