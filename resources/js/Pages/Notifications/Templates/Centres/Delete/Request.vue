            ...
            <div class="pb-3 px-2 space-y-2">
                <div class="bg-white rounded-lg shadow-xl p-4" v-if="show">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                          <h2 class="font-semibold text-gray-800">Request to remove <span class="text-bold text-indigo-600">ANFC {{ form.centre_name }}</span></h2>
...
<script>
    export default{
        ...
        mounted(){
            ...
            .then((res) => {
                this.form.centre_name = res.data.centre_name
            })
            .finally(()=>{
                this.show = true
            });
        ...
        methods: {
            approve() {
                this.$inertia.post(route('approve_centre_delete'), this.form, { preserveState: true})
            },
            reject() {
                this.$inertia.post(route('reject_centre_delete'), this.form, { preserveState: true})
            },
        }
    }
</script>