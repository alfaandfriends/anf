                ...
                <div class="mx-auto">
                    <div class="align-middle inline-block min-w-full">
                        <div class="w-full h-screen flex flex-col items-center justify-center">
                            <div class="items-center justify-center text-center px-4 lg:px-0">
                                ...
                                <p class="text-4xl font-bold text-gray-700 capitalize tracking-wide mt-8">Dashboard under development!</p>
