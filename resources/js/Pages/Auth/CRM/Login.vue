...
import BreezeGuestLayout from '@/Layouts/CRM/Guest.vue';
...
const submit = () => {
    form.post(route('crm.login'), {
        onFinish: () => form.reset('crm.password'),
    });
};
</script>
    ...
    <BreezeGuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4 flex justify-between place-items-end">
                ...
                <Link v-if="canResetPassword" :href="route('crm.password.request')" class="underline text-sm text-gray-500 hover:text-gray-700">
            ...
            <div class="mt-4">
                <div class="flex justify-end">
                    <BreezeButton type="submit" :buttonType="'info'" :class="{ 'px-4 py-2': form.processing }" :disabled="form.processing">
                        Sign in
                    </BreezeButton>
                </div>
