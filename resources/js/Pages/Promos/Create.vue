                                    ...
                                    <div class="grid grid-cols-2 sm:grid-cols-0 gap-0 sm:gap-4">
                                        <div class="mb-4">
                                            ...
                                            <div class="mt-1 flex rounded-md shadow-sm">
                                                <input type="text" name="promo_name" id="promo_name" class="bg-white focus:ring-0 focus:border-indigo-300 flex-1 block w-full rounded-md sm:text-sm" :class="$page.props.errors.promo_name ? 'border-red-300' : 'border-gray-300'" v-model="form.calling_code" autocomplete="off"/>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                                ...
                                                <Multiselect 
                                                    ...
                                                    :classes="{
                                                        container: 
                                                            ...
                                                            'relative mx-auto w-full flex flex-col items-center cursor-pointer border border-red-300 rounded-lg bg-white h-9 rounded-md':
                                                            'relative mx-auto w-full flex flex-col items-center cursor-pointer border border-gray-300 rounded-lg bg-white h-9 rounded-md',
                                                        ...
                                                        search: 'w-full absolute inset-0 outline-none focus:ring-0 appearance-none box-border border-0 text-base font-sans bg-white rounded-md pl-3.5 h-8',
