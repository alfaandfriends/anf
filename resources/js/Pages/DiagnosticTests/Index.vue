    ...
    <BreezeAuthenticatedLayout>
        ...
        <div class="py-4 px-4">
            <div class="flex justify-end">
                <BreezeButton class="py-2.5 px-4 rounded-r-none border-r border-r-white" :route="route('dt.settings.create')">New Diagnostic Test</BreezeButton>
                <!-- <div class="relative inline-block text-left group"> -->
                    <BreezeButton buttonType="info" class="p-2.5 rounded-l-none text-white" :route="route('dt.settings.languages')">
