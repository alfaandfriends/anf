...
export default {
    ...
    data(){
        return{
            form: {
                dt_id: this.$page.props.diagnostic_test_info ? this.$page.props.diagnostic_test_info.id : '',
                name: this.$page.props.diagnostic_test_info ? this.$page.props.diagnostic_test_info.name : '',
                age: this.$page.props.diagnostic_test_info ? this.$page.props.diagnostic_test_info.age_id : '',
                language: this.$page.props.diagnostic_test_info ? this.$page.props.diagnostic_test_info.language_id : '',
                chart_type: this.$page.props.diagnostic_test_info.chart_id ? this.$page.props.diagnostic_test_info.chart_id : this.$page.props.chart_types[0].id,
                lower_score: this.$page.props.diagnostic_test_info ? this.$page.props.diagnostic_test_info.lower_score : '',
                lower_score_direction: this.$page.props.diagnostic_test_info && this.$page.props.diagnostic_test_info.lower_score_direction ? this.$page.props.diagnostic_test_info.lower_score_direction : '',
                higher_score: this.$page.props.diagnostic_test_info ? this.$page.props.diagnostic_test_info.higher_score : '',
                higher_score_direction: this.$page.props.diagnostic_test_info && this.$page.props.diagnostic_test_info.higher_score_direction ? this.$page.props.diagnostic_test_info.higher_score_direction : '',
            }
        }
    },
    methods: {
