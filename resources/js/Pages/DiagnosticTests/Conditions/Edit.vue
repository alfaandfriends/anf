                                    ...
                                    <form @submit.prevent="submit">
                                        <div class="bg-white px-3 py-2">
                                            ...
                                            <div class="flex items-end justify-end space-x-2">
                                                <BreezeButton buttonType="gray" :route="route('dt.settings.details', {'dt_id': condition_info.dt_id})">Cancel</BreezeButton>
...
export default defineComponent({
    ...
    methods: {
        submit() {
            this.$inertia.post(route('dt.settings.conditions.update'), this.form, { preserveState: true})
        }
    }
