...
<body style="padding: 10px">
    ...
    <table width="100%">
        <tr>
            <td><strong style="font-size: 20px">PACKING SLIP</td>
        </tr>
    </table>
    <br/>
    <br/>
    ...
    <table width="100%">
        <thead style="background-color: black; color: white;">
            <tr style="border: 1px solid black">
                ...
                <th style="padding-top:0.5rem; padding-bottom:0.5rem; font-size: 13px; padding-left:1rem; padding-right:1rem;" align="center">Quantity</th>
            </tr>
        </thead>
        <tbody>
