...
<body>
    <div class="artwork_container">
        ...
        <div class="student_name_container">
            <p class="candy_beans student_name">GGWP</p>
        </div>
    </div>
    <div class="page_break"></div>
    <div class="artwork_container">
        <img src="{{ public_path('/images/artbook/templates/level_1/artventure_to_the_beach/cover.jpg') }}" class="artwork_area">
        <img src="{{ public_path('/images/artbook/templates/level_1/artventure_to_the_beach/level_1.jpg') }}" class="artwork">
    </div>
    <div class="page_break"></div>
    <div class="artwork_container">
        <!-- <img src="{{ public_path('/images/artbook/templates/level_1/artventure_to_the_beach/sketch.png') }}" class="artwork_area">
        <img src="{{ public_path('/images/artbook/templates/level_1/artventure_to_the_beach/level_1.jpg') }}" class="artwork"> -->
    </div>
    <div class="page_break"></div>
    <div class="artwork_container">
