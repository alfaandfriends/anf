...
class ClassController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $class_id   =   DB::table('classes')->insertGetId([
            ...
            'start_time'            =>  Carbon::createFromTime($request->start_time['hours'], $request->start_time['minutes'], $request->start_time['seconds']),
            'end_time'              =>  Carbon::createFromTime($request->end_time['hours'], $request->end_time['minutes'], $request->end_time['seconds']),
